...
class _TokoState extends State<Toko> with TickerProviderStateMixin {
  ...
  int get _totalNilai =>
      (_barang ?? []).fold(0, (s, i) => s + ((i.harga ?? 0) * (i.stok ?? 0)));
  ...
  //membuat button untuk menambah barang
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.edit_outlined, size: 15, color: _primary),
            ),
            const SizedBox(width: 10),
            const Text(
              'Edit Barang',
    ...
    child: Row(
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            fontSize: 12,
            color: isLow ? _amber : Colors.white54,
            fontFamily: 'Poppins',
            fontWeight: FontWeight.w600,
          ),
        ),
  ...
  Widget _buildEmpty() => Center(
    child: Column(
      ...
      children: [
        ...
        Text(
          _searchQuery.isEmpty ? 'Belum Ada Produk' : 'Tidak Ditemukan',
          style: const TextStyle(
            fontSize: 15,
            fontWeight: FontWeight.w700,
            color: Colors.white,
